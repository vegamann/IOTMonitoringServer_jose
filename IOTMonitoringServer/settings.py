...
ALLOWED_HOSTS = ["localhost", "ec2-18-208-129-214.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-3-80-135-232.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-90-103-115.compute-1.amazonaws.com"
